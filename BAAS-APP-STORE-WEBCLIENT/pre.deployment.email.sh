...
SMTP_SUBJECT="[DEV] - [DEPLOYMENT STARTS] : DEV_BASS-APP-STORE-WEBCLIENT"_${BUILD_NUMBER}
SMTP_BODY="Automated Deployment for DEV_BASS-APP-STORE-WEBCLIENT has been initiated by code change in the origin/develop branch, please stand by, an email will be sent after deployment has been completed."
