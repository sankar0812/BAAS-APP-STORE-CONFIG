...
SMTP_TO="dineshpandian@gove.co,harish_raj@gove.co,dineshpandian@gove.co"
SMTP_SUBJECT="[TEST FAILED] - [DEPLOYMENT ENDS]: DEV-INSIGHT-REST-DATA-ACCESS"
SMTP_BODY="The Test cases are failed. So,the code is reverted back and attached the test report.Check the code once again."
SMTP_ATTACHMENT="/ops/jenkins/workspace/DEV-INSIGHT-REST-DATA-ACCESS/test-report.html"
